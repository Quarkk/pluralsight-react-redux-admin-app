/* TESTING REDUX ACTIONS Synchronously and Asynchronously
   Framework: Mocha + Expect
   Asynchronous Test Libraries: nock (mock HTTP calls) + redux-mock-store (mock store)
*/
...
describe('Async Actions', () => {
  // Important to call cleanAll() after each call with nock
  afterEach(() => {
    nock.cleanAll();
  });
  ...
  describe('Course Actions Thunk', () => {
    it('should create BEGIN_AJAX_CALL and LOAD_COURSES_SUCCESS when loading courses', (done) => {
      ...
      // Goes to the url required by the api, captures the call
      // but then returns with mocked data instead
      ...
      // Then
      // 'done()' is a callback (passed above) that tells Mocha async work is complete
